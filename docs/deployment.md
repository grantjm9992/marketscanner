...
- **Set `MARKET_DISCOVERY_REFRESH_MS`** so the bot picks up newly-created markets and drops resolved ones without redeploying. Without this, weather markets in particular will all resolve within a couple of days and the bot will silently have nothing to do until you redeploy.
